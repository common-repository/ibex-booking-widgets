...
{var endDate=new Date(this.DateFromString(stDate));endDate.setDate(endDate.getDate()+minStay);var sep,url;if(customUrl==='')
...
{sep=customUrl.indexOf('?')<0?'?':'&';url=customUrl+sep+'datein='+stDate+'&dateout='+this.DateToString(endDate);}
if(this.TargetSafariFix!=''){var redirectURL=encodeURIComponent(url);var url=this.TargetSafariFix+'?url='+redirectURL;}
var newWindow=window.open(url,this.TargetWindow);try
{newWindow.focus();}
catch(e){}}
